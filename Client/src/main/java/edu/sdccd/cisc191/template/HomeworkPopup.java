...
public class HomeworkPopup extends Popup {
    ...
    private AppButton homeworkSubmit = new AppButton();
     ...
     */
    public VBox getHomeworkAdding(TextField inputHomeworkName, CheckBox urgentCheck, DatePicker inputDueDate, ComboBox<String> subjectBox, AppButton homeworkSubmit) {
        nameAdd.setText("Homework Name: ");
        subjectSet.setText("Subject: ");
        urgentSet.setText("Urgent: ");
        dateSet.setText("Due Date: ");
        homeworkSubmit.setText("Submit");
        ...
        VBox homeworkAdding = new VBox(5, homeworkName, homeworkSubject, homeworkDate, homeworkUrgency, homeworkSubmit);
