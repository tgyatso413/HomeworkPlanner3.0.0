...
public class SnackPopup extends Popup {
    ...
    private AppButton sandwichButton = new AppButton();
    private AppButton dessertButton = new AppButton();
    ...
    private AppButton snackButton = new AppButton();
     ...
     */
    public HBox getSandwichOrDessert(AppButton sandwichButton, AppButton dessertButton) {
     ...
     * @param drinkLabel label that displays user's drink
     */
    public void reset(AppButton snackButton, HBox sandwichOrDessertRow, AppLabel snackLabel, AppLabel drinkLabel) {
